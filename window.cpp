    ...
    QMainWindow(parent)
{
    ...
    mFileMenu->addAction(mLoadSubmodelAction);
...
void Window::createActions()
{
    ...
    // open submodel
    mLoadSubmodelAction = new QAction(tr("&Open Submodel"), this);
    mLoadSubmodelAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_B));
    mLoadSubmodelAction->setStatusTip(tr("Loads a submodel"));
    mLoadGroup->addAction(mLoadSubmodelAction);
...
{
    if (action == mLoadSubmodelAction || action == mLoadModelAction)
    {
        //LoadModel
